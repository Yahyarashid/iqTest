...
$('#btn').click(function(){
	if ($( "input:checked" ).length < questions.length){
		...
		if(ratio < 0.4) {
			...
			$('#body').html('<h1 style="text-align: center; margin-right: 9%"> Your score is: '+counter+', You are smart</h1>');
		}
		else if (ratio < 0.90) {
			$('#body').html('<h1 style="text-align: center; margin-right: 9%"> Your score is: '+counter+', You are extremely smart</h1>');
		}
		else {
			$('#body').html('<h1 style="text-align: center; margin-right: 9%"> Your score is: '+counter+', You are super intelligent</h1>');
		}
	$('#btn').hide();
	}
})
